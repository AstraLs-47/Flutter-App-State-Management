...
abstract class $WorkoutCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, DateTime date, bool isCompleted});
}
...
class _$WorkoutImpl implements _Workout {
  ...
  @override
  String toString() {
    return 'Workout(id: $id, name: $name, date: $date, isCompleted: $isCompleted)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, date, isCompleted);
