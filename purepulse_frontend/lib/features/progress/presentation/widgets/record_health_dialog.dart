...
class RecordHealthDialog extends ConsumerStatefulWidget {
  const RecordHealthDialog({super.key});

  @override
  ConsumerState<RecordHealthDialog> createState() => _RecordHealthDialogState();
}

class _RecordHealthDialogState extends ConsumerState<RecordHealthDialog> {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        await ref
                            .read(healthMetricsNotifierProvider.notifier)
                            .addRecord(record);
  ...
  Widget _buildBmiDisplay() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: const Border(
          left: BorderSide(color: Color(0xFF0E6CF2), width: 4),
        ),
      ),
      child: Row(
        children: [
